...
/***/ function(module, exports) {
	...
	function post(options) {
	  ...
	  console.log("going through ajax");
	...
	function docAdd() {
	  ...
	  var arrTab = {
	    'objet': $("#js-objet").val(),
	    'date': $("#dateToDB").val(),
	    //saisie:$("#js-saisie").val(),
	    'statut': $("#js-statut").val(),
	    'type': $("#js-type").val(),
	    // lifeSpan:$("#js-lifeSpan").val(),
	    // debut:$("#js-from").val(),
	    // fin:$("#js-to").val(),
	    'file': $("#js-file").val()
	  };

	  var arrStr = JSON.stringify(arrTab);

	  post({
	    url: './php/doc_create.php',
	    data: arrStr

	  });
	  console.log(arrStr);
	};
	$('#send').listen('click', function () {
	  docAdd();
	});
